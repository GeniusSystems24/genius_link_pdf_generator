...
class _DashboardSidebarState extends State<DashboardSidebar>
  ...
  final List<NavItem> _navItems = [
    ...
    const NavItem(
      id: 's04_data_grid_vnext',
      title: 'S04 DataGrid vNext',
      icon: Icons.table_chart_rounded,
      gradient: AppColors.infoGradient,
    ),
    const NavItem(
      id: 's05_formatting_theme',
      title: 'S05 Formatting & Theme',
    ...
    const NavItem(
      id: 's08_erp_document_families',
      title: 'S08 ERP Document Families',
    ...
    const NavItem(
      id: 's11_print_profiles',
      title: 'S11 Print Profiles',
      icon: Icons.print_rounded,
      gradient: AppColors.infoGradient,
    ),
  const NavItem(
    id: 's13_purchasing_erp_pack',
    title: 'S13 Purchasing ERP Pack',
    icon: Icons.shopping_cart_rounded,
    gradient: AppColors.infoGradient,
  ),
  const NavItem(
    id: 's14_accounting_finance_pack',
    title: 'S14 Accounting & Finance Pack',
    icon: Icons.account_balance_rounded,
    gradient: AppColors.infoGradient,
  ),
  const NavItem(
    id: 's15_inventory_wms_pack',
    title: 'S15 Inventory & WMS Pack',
    icon: Icons.inventory_2_rounded,
    gradient: AppColors.infoGradient,
  ),
  const NavItem(
    id: 's16_pos_retail_pack',
    title: 'S16 POS & Retail Pack',
    icon: Icons.point_of_sale_rounded,
    gradient: AppColors.infoGradient,
  ),
  const NavItem(
    id: 's17_hr_payroll_pack',
    title: 'S17 HR & Payroll Pack',
    icon: Icons.people_alt_rounded,
    gradient: AppColors.infoGradient,
  ),
  const NavItem(
    id: 's18_manufacturing_quality_pack',
    title: 'S18 Manufacturing & Quality Pack',
    icon: Icons.precision_manufacturing_rounded,
    gradient: AppColors.infoGradient,
  ),
  const NavItem(
    id: 's19_fixed_assets_projects_pack',
    title: 'S19 Fixed Assets & Projects Pack',
    icon: Icons.business_center_rounded,
    gradient: AppColors.infoGradient,
  ),
  const NavItem(
    id: 's20_maintenance_service_logistics_pack',
    title: 'S20 Maintenance, Service & Logistics Pack',
  ...
  const NavItem(
    id: 's22_template_engine_vnext',
    title: 'S22 Template Engine vNext',
    icon: Icons.settings_rounded,
    gradient: AppColors.infoGradient,
  ),
  const NavItem(
    id: 's23_compliance_signing_archival',
    title: 'S23 Compliance, Signing & Archival',
    icon: Icons.security_rounded,
    gradient: AppColors.infoGradient,
  ),
  const NavItem(
    id: 's24_performance_regression',
    title: 'S24 Performance & Regression',
    icon: Icons.speed_rounded,
    gradient: AppColors.infoGradient,
  ),
  const NavItem(
    id: 's25_template_designer',
    title: 'S25 Template Designer',
    icon: Icons.design_services_rounded,
    gradient: AppColors.infoGradient,
  ),
  const NavItem(
    id: 's26_industry_packs',
    title: 'S26 Industry / Plugin Packs',
    icon: Icons.extension_rounded,
    gradient: AppColors.infoGradient,
  ),
  const NavItem(
    id: 's12_sales_erp_pack',
    title: 'S12 Sales ERP Pack',
    icon: Icons.point_of_sale_rounded,
    gradient: AppColors.infoGradient,
  ),
    const NavItem(
