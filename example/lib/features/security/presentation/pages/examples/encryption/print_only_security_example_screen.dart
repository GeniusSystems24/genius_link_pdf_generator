...
/// Dedicated screen for the Print Only security example.
///
...
class PrintOnlyProtectionSecurityExampleScreen extends StatelessWidget {
  const PrintOnlyProtectionSecurityExampleScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return SecuritySingleExampleHost(
      example: SecurityExampleKind.printOnlyProtection,
      usageCode: r'''Future<void> _generatePrintOnlyPdf() async {
