...
class S23CopyVerificationExampleScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return VerificationExampleDetailScreen(
      ...
      title: 'Copy',
      description: 'Focused S23 verification for Copy. Generate this example independently, inspect the PDF output, and compare LTR and RTL without switching to another scenario.',
