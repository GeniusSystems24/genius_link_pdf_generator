...
class S00MixedErpBaselineExampleScreen extends StatelessWidget {
  const S00MixedErpBaselineExampleScreen({super.key});
...
class S00MixedBaselineDemoBuilder extends GeniusPdfDocumentBuilder {
  ...
  Widget build(BuildContext context) {
    return S00BaselineExampleDetailScreen(
      ...
      expectedLtr: 'LTR control: labels should be left, values right, and all numeric/Latin ERP identifiers should remain readable.',
      expectedRtl: 'S00 known baseline: Arabic labels should occupy the logical start (right) and amounts the opposite region. Check 13,650.00 SAR, 2,047.50 SAR, 15,697.50 SAR, document number, SKU, IBAN, phone, email and URL. Independent value direction is a known S00 defect and is intentionally not fixed here.',
      fileName: 's00_mixed_baseline.pdf',
    );
  }
}
