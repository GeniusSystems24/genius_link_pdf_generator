...
class S00WatermarkBaselineExampleScreen extends StatelessWidget {
  const S00WatermarkBaselineExampleScreen({super.key});
...
class GridWatermarkConfidentialAuditDemoBuilder extends GeniusPdfDocumentBuilder {
  ...
  Widget build(BuildContext context) {
    return S00BaselineExampleDetailScreen(
      ...
      expectedLtr: 'Watermark must remain visible without clipping or accidental mirroring.',
      expectedRtl: 'Watermark must remain visible without clipping or accidental mirroring.',
      fileName: 's00_watermark.pdf',
    );
  }
}
