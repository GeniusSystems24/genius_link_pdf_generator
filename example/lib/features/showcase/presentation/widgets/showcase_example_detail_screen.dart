...
/// Shared presentation for one focused Showcase PDF example.
///
/// No document is generated when this widget is created. The example waits for
/// an explicit **Run example** action before invoking [buildShowcaseDemoBytes].
class ShowcaseExampleDetailScreen extends StatefulWidget {
  const ShowcaseExampleDetailScreen({
    super.key,
  ...
  @override
  State<ShowcaseExampleDetailScreen> createState() =>
      _ShowcaseExampleDetailScreenState();
}

class _ShowcaseExampleDetailScreenState
...
class _ShowcaseExampleHeader extends StatelessWidget {
  const _ShowcaseExampleHeader({
    required this.category,
    required this.title,
    required this.apiName,
    required this.description,
            ...
            child: pdfData != null
                ...
                : _ExecutionPlaceholder(
                    ...
                    message: error != null
                        ...
                        : 'Press Run example to generate this Showcase document and display its PDF preview.',
                  ),
          ),
        ],
      ),
