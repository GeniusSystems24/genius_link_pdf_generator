...
/// Dedicated single-example screen for **Content Analyzer**.
///
...
class ContentAnalyzerExampleScreen extends StatelessWidget {
  const ContentAnalyzerExampleScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return const AiFeaturesSingleExampleHost(initialTab: 0);
  }
}
