// Global manager/background migration for Custom Report
// GENERATED BY redesign_remaining_multi_example_screens.py
// Internal implementation for the dedicated Custom Report example.
...
class CustomReportSingleExampleHost extends StatefulWidget {
  ...
  @override
  State<CustomReportSingleExampleHost> createState() => _CustomReportSingleExampleHostState();
}

class _CustomReportSingleExampleHostState extends State<CustomReportSingleExampleHost> {
              ...
              ExamplePageHeader(
                ...
                actions: <Widget>[
                  ...
                  FilledButton.icon(
                    ...
                    label: Text(_isGenerating ? 'Generating…' : 'Run example'),
                  ),
                ],
              ),
                  ...
                  child: LayoutBuilder(
                    builder: (context, constraints) {
                      ...
                      return Row(
                        ...
                        children: <Widget>[
                          Expanded(flex: 3, child: _buildSettingsPanel(isDark)),
                          SizedBox(width: spacing.space4),
                          Expanded(flex: 2, child: _buildComponentsPanel(isDark)),
                        ],
                      );
                    },
                  ),
  ...
  void _showUsageCode() {
    const code = '''final config = geniusPdfConfig.copyWith(
  textDirection: isRtl ? TextDirection.rtl : TextDirection.ltr,
);

final options = ShowcaseReportOptions(
...
final builder = ShowcaseReportBuilder(
  config: config,
  options: options,
);
  ...
  Future<void> _generatePdf() async {
    ...
    try {
      ...
      final message = <String, Object?>{
        ...
        'localeName': pdfLocalization.localeName,
      ...
      final result = await generateExamplePdf(
        builder: ExampleBackgroundPdfBuilder(
          ...
          backgroundGenerator: () async {
            final transferred = await Isolate.run<TransferableTypedData>(
              () => _generateCustomReportWorker(message),
              debugName: 'custom-report-generator',
            );
        ...
        metadata: <String, dynamic>{
          ...
          'screen': 'CustomReportSingleExampleHost',
          'workflow': 'custom-report-preview',
...
Future<TransferableTypedData> _generateCustomReportWorker(
  Map<String, Object?> message,
) async {
  final localeName = message['localeName']! as String;
  PDFGeneratorLocalizationRuntime.bind(
    lookupPDFGeneratorLocalization(Locale(localeName.split('_').first)),
  );

  var config = restoreExamplePdfConfig(
    message['config']! as Map<String, Object?>,
  );
  config = config.copyWith(
    baseFont: PdfTrueTypeFont(config.assets.primaryFont.toList(), 10),
  );

  final logoBytes = config.assets.logo;
  final headerBytes = config.assets.headerImage;

  final options = _ShowcaseReportOptions(
    reportTitle: message['reportTitle']! as String,
    reportTitleAr: message['reportTitleAr']! as String,
    companyName: message['companyName']! as String,
    companyNameAr: message['companyNameAr']! as String,
    includeHeader: message['includeHeader']! as bool,
    includeFooter: message['includeFooter']! as bool,
    includeLogo: message['includeLogo']! as bool,
    includeReportHeader: message['includeReportHeader']! as bool,
    includeInfoBox: message['includeInfoBox']! as bool,
    includeDataGrid: message['includeDataGrid']! as bool,
    includeRichText: message['includeRichText']! as bool,
    includeSummary: message['includeSummary']! as bool,
    includeBulletList: message['includeBulletList']! as bool,
    includeTwoColumns: message['includeTwoColumns']! as bool,
    includeQrCode: message['includeQrCode']! as bool,
    includeBarcode: message['includeBarcode']! as bool,
    includeImages: message['includeImages']! as bool,
    includeAttachments: message['includeAttachments']! as bool,
    includeWatermark: message['includeWatermark']! as bool,
    includeDigitalSignature: message['includeDigitalSignature']! as bool,
    includeSignatureArea: message['includeSignatureArea']! as bool,
    infoBoxTitle: message['infoBoxTitle']! as String,
    infoBoxContent: message['infoBoxContent']! as String,
    infoBoxStyleType: message['infoBoxStyleType']! as String,
    gridRows: message['gridRows']! as int,
    gridColumns: message['gridColumns']! as int,
    gridShowTotals: message['gridShowTotals']! as bool,
    subtotal: (message['subtotal']! as num).toDouble(),
    tax: (message['tax']! as num).toDouble(),
    discount: (message['discount']! as num).toDouble(),
    logoImage: logoBytes == null
        ? null
        : GeniusPdfImage(data: logoBytes, width: 120, height: 120),
    headerImage: headerBytes == null
        ? null
        : GeniusPdfImage(data: headerBytes, width: 800, height: 120),
  );
