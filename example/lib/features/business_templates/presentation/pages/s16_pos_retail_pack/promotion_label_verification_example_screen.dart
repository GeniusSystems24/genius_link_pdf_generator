...
class S16PromotionLabelVerificationExampleScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BusinessVerificationExampleDetailScreen(
      ...
      description: 'Focused S16 verification for Promotion Label. Generate this scenario independently, inspect the PDF output, and compare LTR and RTL without switching to another example.',
      apiName: 'buildS16PromotionLabelVerificationPdf',
      icon: Icons.point_of_sale_outlined,
      generator: buildS16PromotionLabelVerificationPdf,
      usageCode: dartUsageCode,
      fileName: 's16_pos_retail_pack_promotion_label.pdf',
    );
  }
}
