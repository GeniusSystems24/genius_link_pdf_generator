...
class S12PriceListVerificationExampleScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BusinessVerificationExampleDetailScreen(
      ...
      title: 'Price List',
      description: 'Focused S12 verification for Price List. Generate this scenario independently, inspect the PDF output, and compare LTR and RTL without switching to another example.',
      apiName: 'buildS12PriceListVerificationPdf',
      icon: Icons.point_of_sale_outlined,
      generator: buildS12PriceListVerificationPdf,
      usageCode: dartUsageCode,
      fileName: 's12_sales_erp_pack_price_list.pdf',
    );
  }
}
