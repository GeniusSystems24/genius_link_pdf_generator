...
class S12BySalespersonVerificationExampleScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BusinessVerificationExampleDetailScreen(
      ...
      description: 'Focused S12 verification for Sales by Salesperson. Generate this scenario independently, inspect the PDF output, and compare LTR and RTL without switching to another example.',
      apiName: 'buildS12BySalespersonVerificationPdf',
      icon: Icons.point_of_sale_outlined,
      generator: buildS12BySalespersonVerificationPdf,
      usageCode: dartUsageCode,
      fileName: 's12_sales_erp_pack_by_salesperson.pdf',
    );
  }
}
