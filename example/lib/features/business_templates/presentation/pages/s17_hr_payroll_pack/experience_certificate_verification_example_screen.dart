...
class S17ExperienceCertificateVerificationExampleScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BusinessVerificationExampleDetailScreen(
      ...
      description: 'Focused S17 verification for Experience Certificate. Generate this scenario independently, inspect the PDF output, and compare LTR and RTL without switching to another example.',
      apiName: 'buildS17ExperienceCertificateVerificationPdf',
      icon: Icons.groups_outlined,
      generator: buildS17ExperienceCertificateVerificationPdf,
      usageCode: dartUsageCode,
      fileName: 's17_hr_payroll_pack_experience_certificate.pdf',
    );
  }
}
