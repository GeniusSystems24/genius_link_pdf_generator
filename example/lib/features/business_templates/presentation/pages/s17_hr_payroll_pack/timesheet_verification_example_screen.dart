...
class S17TimesheetVerificationExampleScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BusinessVerificationExampleDetailScreen(
      ...
      title: 'Timesheet',
      description: 'Focused S17 verification for Timesheet. Generate this scenario independently, inspect the PDF output, and compare LTR and RTL without switching to another example.',
      apiName: 'buildS17TimesheetVerificationPdf',
      icon: Icons.groups_outlined,
      generator: buildS17TimesheetVerificationPdf,
      usageCode: dartUsageCode,
      fileName: 's17_hr_payroll_pack_timesheet.pdf',
    );
  }
}
