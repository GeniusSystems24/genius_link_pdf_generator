...
class S17LeaveBalanceVerificationExampleScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BusinessVerificationExampleDetailScreen(
      ...
      title: 'Leave Balance',
      description: 'Focused S17 verification for Leave Balance. Generate this scenario independently, inspect the PDF output, and compare LTR and RTL without switching to another example.',
