...
class S18RoutingVerificationExampleScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BusinessVerificationExampleDetailScreen(
      ...
      description: 'Focused S18 verification for Routing / Traveler. Generate this scenario independently, inspect the PDF output, and compare LTR and RTL without switching to another example.',
      apiName: 'buildS18RoutingVerificationPdf',
      icon: Icons.precision_manufacturing_outlined,
      generator: buildS18RoutingVerificationPdf,
      usageCode: dartUsageCode,
      fileName: 's18_manufacturing_quality_pack_routing.pdf',
    );
  }
}
