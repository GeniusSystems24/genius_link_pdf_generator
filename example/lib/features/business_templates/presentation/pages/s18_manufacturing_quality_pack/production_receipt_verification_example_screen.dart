...
class S18ProductionReceiptVerificationExampleScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BusinessVerificationExampleDetailScreen(
      ...
      description: 'Focused S18 verification for Production Receipt. Generate this scenario independently, inspect the PDF output, and compare LTR and RTL without switching to another example.',
      apiName: 'buildS18ProductionReceiptVerificationPdf',
      icon: Icons.precision_manufacturing_outlined,
      generator: buildS18ProductionReceiptVerificationPdf,
      usageCode: dartUsageCode,
      fileName: 's18_manufacturing_quality_pack_production_receipt.pdf',
    );
  }
}
