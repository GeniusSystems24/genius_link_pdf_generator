...
class S18CoaVerificationExampleScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BusinessVerificationExampleDetailScreen(
      ...
      description: 'Focused S18 verification for Certificate of Analysis. Generate this scenario independently, inspect the PDF output, and compare LTR and RTL without switching to another example.',
      apiName: 'buildS18CoaVerificationPdf',
      icon: Icons.precision_manufacturing_outlined,
      generator: buildS18CoaVerificationPdf,
      usageCode: dartUsageCode,
      fileName: 's18_manufacturing_quality_pack_coa.pdf',
    );
  }
}
