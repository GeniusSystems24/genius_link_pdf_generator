...
class S18AuditVerificationExampleScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BusinessVerificationExampleDetailScreen(
      ...
      title: 'Audit Form',
      description: 'Focused S18 verification for Audit Form. Generate this scenario independently, inspect the PDF output, and compare LTR and RTL without switching to another example.',
      apiName: 'buildS18AuditVerificationPdf',
      icon: Icons.precision_manufacturing_outlined,
      generator: buildS18AuditVerificationPdf,
      usageCode: dartUsageCode,
      fileName: 's18_manufacturing_quality_pack_audit.pdf',
    );
  }
}
