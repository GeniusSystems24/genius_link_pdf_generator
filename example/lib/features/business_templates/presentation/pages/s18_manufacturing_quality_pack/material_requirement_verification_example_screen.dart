...
class S18MaterialRequirementVerificationExampleScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BusinessVerificationExampleDetailScreen(
      ...
      description: 'Focused S18 verification for Material Requirement. Generate this scenario independently, inspect the PDF output, and compare LTR and RTL without switching to another example.',
      apiName: 'buildS18MaterialRequirementVerificationPdf',
      icon: Icons.precision_manufacturing_outlined,
      generator: buildS18MaterialRequirementVerificationPdf,
      usageCode: dartUsageCode,
      fileName: 's18_manufacturing_quality_pack_material_requirement.pdf',
    );
  }
}
