...
class S18QualityInspectionVerificationExampleScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BusinessVerificationExampleDetailScreen(
      ...
      description: 'Focused S18 verification for Quality Inspection. Generate this scenario independently, inspect the PDF output, and compare LTR and RTL without switching to another example.',
      apiName: 'buildS18QualityInspectionVerificationPdf',
      icon: Icons.precision_manufacturing_outlined,
      generator: buildS18QualityInspectionVerificationPdf,
      usageCode: dartUsageCode,
      fileName: 's18_manufacturing_quality_pack_quality_inspection.pdf',
    );
  }
}
