...
class S18ScrapVerificationExampleScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BusinessVerificationExampleDetailScreen(
      ...
      title: 'Scrap Report',
      description: 'Focused S18 verification for Scrap Report. Generate this scenario independently, inspect the PDF output, and compare LTR and RTL without switching to another example.',
      apiName: 'buildS18ScrapVerificationPdf',
      icon: Icons.precision_manufacturing_outlined,
      generator: buildS18ScrapVerificationPdf,
      usageCode: dartUsageCode,
      fileName: 's18_manufacturing_quality_pack_scrap.pdf',
    );
  }
}
