...
class S15LocationLabelVerificationExampleScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BusinessVerificationExampleDetailScreen(
      ...
      description: 'Focused S15 verification for Location Label. Generate this scenario independently, inspect the PDF output, and compare LTR and RTL without switching to another example.',
      apiName: 'buildS15LocationLabelVerificationPdf',
      icon: Icons.inventory_2_outlined,
      generator: buildS15LocationLabelVerificationPdf,
      usageCode: dartUsageCode,
      fileName: 's15_inventory_wms_pack_location_label.pdf',
    );
  }
}
