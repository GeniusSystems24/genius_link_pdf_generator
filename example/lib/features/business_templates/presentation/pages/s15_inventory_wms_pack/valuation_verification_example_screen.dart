...
class S15ValuationVerificationExampleScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BusinessVerificationExampleDetailScreen(
      ...
      description: 'Focused S15 verification for Stock Valuation. Generate this scenario independently, inspect the PDF output, and compare LTR and RTL without switching to another example.',
      apiName: 'buildS15ValuationVerificationPdf',
      icon: Icons.inventory_2_outlined,
      generator: buildS15ValuationVerificationPdf,
      usageCode: dartUsageCode,
      fileName: 's15_inventory_wms_pack_valuation.pdf',
    );
  }
}
