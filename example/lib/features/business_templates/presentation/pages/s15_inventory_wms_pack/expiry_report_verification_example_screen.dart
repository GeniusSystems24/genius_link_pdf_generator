...
class S15ExpiryReportVerificationExampleScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BusinessVerificationExampleDetailScreen(
      ...
      title: 'Expiry Report',
      description: 'Focused S15 verification for Expiry Report. Generate this scenario independently, inspect the PDF output, and compare LTR and RTL without switching to another example.',
      apiName: 'buildS15ExpiryReportVerificationPdf',
      icon: Icons.inventory_2_outlined,
      generator: buildS15ExpiryReportVerificationPdf,
      usageCode: dartUsageCode,
      fileName: 's15_inventory_wms_pack_expiry_report.pdf',
    );
  }
}
