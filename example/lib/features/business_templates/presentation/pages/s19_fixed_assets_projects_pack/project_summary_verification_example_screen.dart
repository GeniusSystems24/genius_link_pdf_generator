...
class S19ProjectSummaryVerificationExampleScreen extends StatelessWidget {
  ...
  static const String dartUsageCode = r'''Future<Uint8List> buildS19ProjectSummaryVerificationPdf(GeniusPdfConfig config) {
  ...
  Widget build(BuildContext context) {
    return BusinessVerificationExampleDetailScreen(
      ...
      fileName: 's19_fixed_assets_projects_pack_project_summary.pdf',
    );
  }
}
