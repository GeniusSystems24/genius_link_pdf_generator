...
class S14ProjectFinancialVerificationExampleScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BusinessVerificationExampleDetailScreen(
      ...
      description: 'Focused S14 verification for Project Financial. Generate this scenario independently, inspect the PDF output, and compare LTR and RTL without switching to another example.',
      apiName: 'buildS14ProjectFinancialVerificationPdf',
      icon: Icons.account_balance_outlined,
      generator: buildS14ProjectFinancialVerificationPdf,
      usageCode: dartUsageCode,
      fileName: 's14_accounting_finance_pack_project_financial.pdf',
    );
  }
}
