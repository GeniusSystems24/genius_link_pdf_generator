...
class S14ReceiptRegisterVerificationExampleScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BusinessVerificationExampleDetailScreen(
      ...
      description: 'Focused S14 verification for Receipt Register. Generate this scenario independently, inspect the PDF output, and compare LTR and RTL without switching to another example.',
      apiName: 'buildS14ReceiptRegisterVerificationPdf',
      icon: Icons.account_balance_outlined,
      generator: buildS14ReceiptRegisterVerificationPdf,
      usageCode: dartUsageCode,
      fileName: 's14_accounting_finance_pack_receipt_register.pdf',
    );
  }
}
