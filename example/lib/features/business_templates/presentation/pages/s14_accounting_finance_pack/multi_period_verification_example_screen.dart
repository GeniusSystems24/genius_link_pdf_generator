...
class S14MultiPeriodVerificationExampleScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BusinessVerificationExampleDetailScreen(
      ...
      description: 'Focused S14 verification for Multi-period Comparison. Generate this scenario independently, inspect the PDF output, and compare LTR and RTL without switching to another example.',
      apiName: 'buildS14MultiPeriodVerificationPdf',
      icon: Icons.account_balance_outlined,
      generator: buildS14MultiPeriodVerificationPdf,
      usageCode: dartUsageCode,
      fileName: 's14_accounting_finance_pack_multi_period.pdf',
    );
  }
}
