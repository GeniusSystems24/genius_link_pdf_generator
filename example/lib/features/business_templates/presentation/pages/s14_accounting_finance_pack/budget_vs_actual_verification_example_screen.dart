...
class S14BudgetVsActualVerificationExampleScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BusinessVerificationExampleDetailScreen(
      ...
      description: 'Focused S14 verification for Budget vs Actual. Generate this scenario independently, inspect the PDF output, and compare LTR and RTL without switching to another example.',
      apiName: 'buildS14BudgetVsActualVerificationPdf',
      icon: Icons.account_balance_outlined,
      generator: buildS14BudgetVsActualVerificationPdf,
      usageCode: dartUsageCode,
      fileName: 's14_accounting_finance_pack_budget_vs_actual.pdf',
    );
  }
}
