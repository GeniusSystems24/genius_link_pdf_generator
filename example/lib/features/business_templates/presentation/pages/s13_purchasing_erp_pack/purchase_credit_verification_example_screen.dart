...
class S13PurchaseCreditVerificationExampleScreen extends StatelessWidget {
  ...
  static const String dartUsageCode = r'''Future<Uint8List> buildS13PurchaseCreditVerificationPdf(GeniusPdfConfig config) {
  ...
  Widget build(BuildContext context) {
    return BusinessVerificationExampleDetailScreen(
      ...
      fileName: 's13_purchasing_erp_pack_purchase_credit.pdf',
    );
  }
}
