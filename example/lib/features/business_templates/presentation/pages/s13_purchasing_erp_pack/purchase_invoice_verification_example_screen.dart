...
class S13PurchaseInvoiceVerificationExampleScreen extends StatelessWidget {
  ...
  static const String dartUsageCode = r'''Future<Uint8List> buildS13PurchaseInvoiceVerificationPdf(GeniusPdfConfig config) {
  ...
  Widget build(BuildContext context) {
    return BusinessVerificationExampleDetailScreen(
      ...
      fileName: 's13_purchasing_erp_pack_purchase_invoice.pdf',
    );
  }
}
