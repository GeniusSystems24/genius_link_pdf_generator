...
class S13RfqVerificationExampleScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BusinessVerificationExampleDetailScreen(
      ...
      description: 'Focused S13 verification for Request for Quotation. Generate this scenario independently, inspect the PDF output, and compare LTR and RTL without switching to another example.',
      apiName: 'buildS13RfqVerificationPdf',
      icon: Icons.shopping_cart_checkout_outlined,
      generator: buildS13RfqVerificationPdf,
      usageCode: dartUsageCode,
      fileName: 's13_purchasing_erp_pack_rfq.pdf',
    );
  }
}
