...
class S13PurchaseOrderVerificationExampleScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BusinessVerificationExampleDetailScreen(
      ...
      description: 'Focused S13 verification for Purchase Order. Generate this scenario independently, inspect the PDF output, and compare LTR and RTL without switching to another example.',
      apiName: 'buildS13PurchaseOrderVerificationPdf',
      icon: Icons.shopping_cart_checkout_outlined,
      generator: buildS13PurchaseOrderVerificationPdf,
      usageCode: dartUsageCode,
      fileName: 's13_purchasing_erp_pack_purchase_order.pdf',
    );
  }
}
