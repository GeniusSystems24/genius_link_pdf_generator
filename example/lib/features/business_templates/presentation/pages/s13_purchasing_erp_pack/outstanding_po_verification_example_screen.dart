...
class S13OutstandingPoVerificationExampleScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BusinessVerificationExampleDetailScreen(
      ...
      description: 'Focused S13 verification for Outstanding Purchase Orders. Generate this scenario independently, inspect the PDF output, and compare LTR and RTL without switching to another example.',
      apiName: 'buildS13OutstandingPoVerificationPdf',
      icon: Icons.shopping_cart_checkout_outlined,
      generator: buildS13OutstandingPoVerificationPdf,
      usageCode: dartUsageCode,
      fileName: 's13_purchasing_erp_pack_outstanding_po.pdf',
    );
  }
}
