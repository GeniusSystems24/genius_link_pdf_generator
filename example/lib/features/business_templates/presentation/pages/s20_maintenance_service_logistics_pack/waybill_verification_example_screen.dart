...
class S20WaybillVerificationExampleScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BusinessVerificationExampleDetailScreen(
      ...
      title: 'Waybill',
      description: 'Focused S20 verification for Waybill. Generate this scenario independently, inspect the PDF output, and compare LTR and RTL without switching to another example.',
      apiName: 'buildS20WaybillVerificationPdf',
      icon: Icons.local_shipping_outlined,
      generator: buildS20WaybillVerificationPdf,
      usageCode: dartUsageCode,
      fileName: 's20_maintenance_service_logistics_pack_waybill.pdf',
    );
  }
}
