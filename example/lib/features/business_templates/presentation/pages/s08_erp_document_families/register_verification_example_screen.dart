...
class S08RegisterVerificationExampleScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BusinessVerificationExampleDetailScreen(
      ...
      title: 'Register',
      description: 'Focused S08 verification for Register. Generate this scenario independently, inspect the PDF output, and compare LTR and RTL without switching to another example.',
      apiName: 'buildS08RegisterVerificationPdf',
      icon: Icons.account_tree_outlined,
      generator: buildS08RegisterVerificationPdf,
      usageCode: dartUsageCode,
      fileName: 's08_erp_document_families_register.pdf',
    );
  }
}
