...
/// Dedicated single-example screen for **Template Registry**.
///
...
class TemplateRegistryExampleScreen extends StatelessWidget {
  const TemplateRegistryExampleScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return const TemplateEngineSingleExampleHost(initialTab: 2);
  }
}
