...
class S25AuthoringVerificationExampleScreen extends StatefulWidget {
  ...
  @override
  State<S25AuthoringVerificationExampleScreen> createState() => _S25AuthoringVerificationExampleScreenState();
}

class _S25AuthoringVerificationExampleScreenState extends State<S25AuthoringVerificationExampleScreen> {
  String _profile = 'a4-portrait';
  int _rows = 10;

  static const String dartUsageCode = r'''Future<Uint8List> buildS25AuthoringVerificationPdf(
  ...
  Widget build(BuildContext context) {
    return VerificationExampleDetailScreen(
      ...
      fileName: 's25_template_designer_authoring.pdf',
