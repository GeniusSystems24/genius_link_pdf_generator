...
class _S22ScopedRegistryVerificationExampleScreenState extends State<S22ScopedRegistryVerificationExampleScreen> {
  ...
  Widget build(BuildContext context) {
    return VerificationExampleDetailScreen(
      ...
      description: 'Focused S22 verification for Registry Fallback / History. Generate this example independently, inspect the PDF output, and compare LTR and RTL without switching to another scenario.',
