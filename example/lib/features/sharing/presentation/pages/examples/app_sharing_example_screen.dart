...
/// Dedicated single-example screen for **App Sharing**.
///
...
class AppSharingExampleScreen extends StatelessWidget {
  const AppSharingExampleScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return const SharingSingleExampleHost(initialTab: 3);
  }
}
