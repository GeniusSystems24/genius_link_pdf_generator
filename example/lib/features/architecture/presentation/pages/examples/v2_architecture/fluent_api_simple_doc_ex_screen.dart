...
/// Focused V2 Architecture example for Simple Document.
class FluentApiSimpleDocumentExampleScreen extends StatelessWidget {
  const FluentApiSimpleDocumentExampleScreen({super.key});

  /// Exact code executed by this example.
  static const String dartUsageCode = r'''Future<Uint8List> buildSimpleDocumentBytes() async {
  ...
  Widget build(BuildContext context) {
    return const V2ArchitectureSingleExampleHost(
      example: V2ArchitectureExample.simpleDocument,
