...
/// Focused V2 Architecture example for Invoice.
class FluentApiInvoiceExampleScreen extends StatelessWidget {
  const FluentApiInvoiceExampleScreen({super.key});

  /// Exact code executed by this example.
  static const String dartUsageCode = r'''Future<Uint8List> buildInvoiceDocumentBytes() async {
  ...
  Widget build(BuildContext context) {
    return const V2ArchitectureSingleExampleHost(
      example: V2ArchitectureExample.invoice,
