...
class S06LongMultiPageVerificationExampleScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return VerificationExampleDetailScreen(
      ...
      description: 'Focused S06 verification for Long / Multi-page Domain. Generate the document explicitly, inspect the PDF result, and compare LTR and RTL output without switching to another scenario.',
      apiName: 'buildS06LongMultiPageVerificationPdf',
      icon: Icons.calculate_outlined,
      generator: buildS06LongMultiPageVerificationPdf,
      fileName: 's06_erp_domain_calculation_long_multi_page.pdf',
