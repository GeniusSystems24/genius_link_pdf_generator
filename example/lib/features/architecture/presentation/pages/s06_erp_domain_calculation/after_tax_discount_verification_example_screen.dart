...
class S06AfterTaxDiscountVerificationExampleScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return VerificationExampleDetailScreen(
      ...
      description: 'Focused S06 verification for Discount After Tax. Generate the document explicitly, inspect the PDF result, and compare LTR and RTL output without switching to another scenario.',
      apiName: 'buildS06AfterTaxDiscountVerificationPdf',
      icon: Icons.calculate_outlined,
      generator: buildS06AfterTaxDiscountVerificationPdf,
      fileName: 's06_erp_domain_calculation_after_tax_discount.pdf',
