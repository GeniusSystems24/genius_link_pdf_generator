...
class S06MultiTaxVerificationExampleScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return VerificationExampleDetailScreen(
      ...
      description: 'Focused S06 verification for Multi-tax / Compound. Generate the document explicitly, inspect the PDF result, and compare LTR and RTL output without switching to another scenario.',
