// Generated by create_template_html_export_examples.py.
//
// Every public function below is intentionally self-contained so its exact
// source can be displayed verbatim in `Dart usage code`.
...
/// Result of exporting one business template to HTML.
final class TemplateHtmlExportResult {
  const TemplateHtmlExportResult({
    required this.data,
    required this.html,
    required this.filePath,
    required this.pageCount,
    required this.embedImages,
    required this.includeStyles,
  });

  /// Exact bytes returned by [GeniusPdfExportService].
  final Uint8List data;

  /// UTF-8 decoded view of [data].
  final String html;

  /// Saved `.html` file path.
  final String filePath;

  /// Number of source PDF pages converted.
  final int pageCount;

  /// Value supplied to [GeniusExportConfiguration.html].
...
/// Builds the Balance Sheet template and exports it as HTML.
...
/// Builds the Income Statement template and exports it as HTML.
...
/// Builds the Cash Flow template and exports it as HTML.
...
/// Builds the Budget Report template and exports it as HTML.
...
/// Builds the Quotation template and exports it as HTML.
...
/// Builds the Purchase Order template and exports it as HTML.
...
/// Builds the Delivery Note template and exports it as HTML.
...
/// Builds the Credit Note template and exports it as HTML.
...
/// Builds the Payslip template and exports it as HTML.
...
/// Builds the Employee Report template and exports it as HTML.
...
/// Builds the Attendance Report template and exports it as HTML.
...
/// Builds the Leave Report template and exports it as HTML.
...
/// Builds the Trial Balance template and exports it as HTML.
