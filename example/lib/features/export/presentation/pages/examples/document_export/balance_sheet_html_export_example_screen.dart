...
class BalanceSheetHtmlExportExampleScreen extends StatelessWidget {
  ...
  static const String dartUsageCode = r'''/// Builds the Balance Sheet template and exports it as HTML.
Future<TemplateHtmlExportResult> exportBalanceSheetTemplateAsHtml({
  required bool isRtl,
    ...
    switch (result) {
      case GeniusExportSuccess(:final data, :final pageCount):
        ...
        final path = await documents.saveBytes(
          bytes: data,
          fileName: 'balance_sheet_${direction}_${styleMode}.html',
        );
