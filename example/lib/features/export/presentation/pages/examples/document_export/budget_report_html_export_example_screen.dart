...
class BudgetReportHtmlExportExampleScreen extends StatelessWidget {
  ...
  static const String dartUsageCode = r'''/// Builds the Budget Report template and exports it as HTML.
Future<TemplateHtmlExportResult> exportBudgetReportTemplateAsHtml({
  required bool isRtl,
    ...
    switch (result) {
      case GeniusExportSuccess(:final data, :final pageCount):
        ...
        final path = await documents.saveBytes(
          bytes: data,
          fileName: 'budget_report_${direction}_${styleMode}.html',
        );
