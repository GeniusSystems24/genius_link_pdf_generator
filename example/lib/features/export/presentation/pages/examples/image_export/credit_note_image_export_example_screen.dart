...
/// Exports the Credit Note business template to PNG or JPEG images.
class CreditNoteImageExportExampleScreen extends StatelessWidget {
  const CreditNoteImageExportExampleScreen({super.key});

  /// Exact source of the generator function executed by this screen.
  static const String dartUsageCode = r'''/// Builds the Credit Note template and exports every PDF page as an image.
Future<TemplateImageExportResult> exportCreditNoteTemplateAsImages({
  ...
  Widget build(BuildContext context) {
    return TemplateImageExportDetailScreen(
      ...
      title: 'Credit Note',
      description: 'Generate the Credit Note template, rasterize every PDF page, save it as PNG or JPEG, and preview the exported image bytes.',
      icon: Icons.receipt_long_outlined,
      exportTemplate: exportCreditNoteTemplateAsImages,
