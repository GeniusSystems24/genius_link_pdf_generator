...
class GeniusPdfVoucherStyle {
  const GeniusPdfVoucherStyle({
    ...
    this.secondaryColor = const Color(0xFF283593),
    this.headerTextColor = const Color(0xFFFFFFFF),
    this.borderColor = const Color(0xFFBDBDBD),
    this.tableHeaderColor = const Color(0xFFE8EAF6),
    this.tableHeaderTextColor = const Color(0xFF1A237E),
    ...
    this.badgeColor = const Color(0xFF0D47A1),
